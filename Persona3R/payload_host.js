(function () {
  ...
  jsmaf.root.children.length = 0;
      new Style({ name: 'payloadText', color: 'black', size: 28 });
    new Style({ name: 'payloadTextSel', color: 'white', size: 28 });
...
var currentButton = 0;
  ...
  var textOrigPos = [];
  var fileList = [];
    var normalButtonImg = 'file://../download0/themes/Persona3R/img/white.png';
    var selectedButtonImg = 'file://../download0/themes/Persona3R/img/red.png';
  var background = new Image({
    url: 'file://../download0/themes/Persona3R/img/bgPayload.png',
    x: 0,
    y: 0,
    width: 1920,
    height: 1080
