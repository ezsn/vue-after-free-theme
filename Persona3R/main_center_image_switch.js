(function () {
  ...
  // Force menu labels to use custom image text (no plain text)
  var useImageText = false;
  // Put your label images here: Jailbreak.png, Payload.png, Config.png, Exit.png
  var textImageBase = 'file:///../download0/themes/Persona3Reload/img/';
  var currentButton = 0;
  var buttons = [];
  var buttonTexts = [];
  var buttonMarkers = [];
  var buttonOrigPos = [];
  var textOrigPos = [];
  var normalButtonImg = 'file://../download0/themes/Persona3Reload/img/ps4_bar_normal.png';
  var selectedButtonImg = 'file://../download0/themes/Persona3Reload/img/ps4_bar_selected.png';
  ...
  var background = new Image({
    url: 'file://../download0/themes/Persona3Reload/img/background.png',
    x: 0,
    y: 0,
    width: 1920,
    height: 1080
