...
(function () {
  ...
  var selectedButtonImg = 'file://../download0/themes/Persona3R/img/white.png';
  jsmaf.root.children.length = 0;
    new Style({ name: 'menu', color: 'rgb(70, 240, 240)', size: 30 });
  new Style({ name: 'menuSelected', color: 'black', size: 30 });
  new Style({ name: 'value', color: 'rgb(70, 240, 240)', size: 28 });
  new Style({ name: 'valueSelected', color: 'red', size: 28 });
  ...
  var background = new Image({
    url: 'file://../download0/themes/Persona3R/img/bgConfig.png',
    x: 0,
    y: 0,
    width: 1920,
    height: 1080
