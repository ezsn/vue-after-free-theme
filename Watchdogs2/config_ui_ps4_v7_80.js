...
(function () {
      ...
      if (configOption.key === 'jb_behavior') {
        if (useImageText) {
          ...
          valueLabel.text = jbBehaviorLabels[currentConfig.jb_behavior] || jbBehaviorLabels[0];
                    valueLabel.x = btnX + buttonWidth - 220;
  ...
  backHint.x = centerX - 48;
  backHint.y = startY + configOptions.length * buttonSpacing + 77;
  backHint.style = 'white';
  jsmaf.root.children.push(backHint);  var prevButton = -1;
